...
const radio = {
   ...
   "powerpop": "https://listen.powerapp.com.tr/powerpop/mpeg/icecast.audio?/;stream.nsv"
}
      ...
      if (!args) return msg.channel.send('❌ | Bir Radyo Seçin : **number1**, **powerturk**, **power**, **metrofm**, **fenomen**, **slowtürk**, **powerpop**')
